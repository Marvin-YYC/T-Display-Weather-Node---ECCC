Weather Information Display for TTGO T-display and information from Environment Canada / NavCanada weather stations

This is a work in progress.

I haven't added any additional fonts or other complications at this time.  I did set up the left button of the T-display to control the backlight.

Just a basic sketch to featch current weather and weather alert data from Enviroment Canada and Nav Canada weather stations.
